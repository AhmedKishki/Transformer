...
class Config:
    ...
    def __init__(self):
        self.batch_size = 100 # number of independent sequences to be processed in parallel
        self.N = 6 # model consists of a stack of N identical layers. This hyperparameter determines how deep the model is and affects its capacity to learn complex patterns
        self.d_model = 512 # determines the dimensionality of the model's internal representations at each layer
        self.h = 8 # number of attention heads, denoted as 'h,' is a hyperparameter that influences the diversity and quality of learned representations
